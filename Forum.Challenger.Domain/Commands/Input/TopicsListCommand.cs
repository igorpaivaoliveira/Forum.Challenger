...
{
    public class TopicsListCommand : Request<Response>
    {
        public TopicsListCommand(int cdTopic = 0, DateTime? dtTopic = null, DateTime? dtTopicLastEdition = null, string dsTitle = null, string dsText = null, int cdPerson = 0, bool flActive = false)
        {
            CdTopic = cdTopic;
            DtTopic = dtTopic;
